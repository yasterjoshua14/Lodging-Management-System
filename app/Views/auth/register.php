...
<?= $this->section('content') ?>
    <div class="section-head">
        <div>
            ...
            <p>Register a tenant portal account that links to your own customer profile.</p>
        </div>
    </div>
    ...
    <p class="auth-switch">Already registered? <a class="link-inline" href="/login">Back to customer login</a>.</p>
<?= $this->endSection() ?>
